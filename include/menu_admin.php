<div class="col-md-3 left_col menu_fixed">
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="index.php" class="site_title"><img src="https://iestphuanta.edu.pe/wp-content/uploads/2021/12/logo_tecno.png" alt="" width="70%"> <span></span></a>
        </div>
            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li><a><i class="fa fa-check-square-o"></i> Usuarios <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li class="sub_menu"><a href="#">Usuarios</a></li>
                        </ul>
                    </li>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="">
                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                        <img src="../img/no-image.jpeg" alt="">usuario
